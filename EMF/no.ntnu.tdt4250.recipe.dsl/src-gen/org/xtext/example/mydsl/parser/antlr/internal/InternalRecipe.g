...
@after {
	...
	(
		...
		{
			$current = $this_Ingredients_0.current;
			afterParserOrEnumRuleCall();
		}
		    |
		{
		...
		{
			$current = $this_Instructions_1.current;
			afterParserOrEnumRuleCall();
		}
		    |
		{
		...
		{
			$current = $this_Nutrients_2.current;
			afterParserOrEnumRuleCall();
		}
	)
;
