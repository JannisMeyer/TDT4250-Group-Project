...
class APIGenerator {
    ...
    def generateKotlinFile(Page page) '''
        ...
        fun convertToRecipe(recipeInfo: RecipeInformation): Recipe {
        	...
        	«val nutrients = page.nutrients»
            «IF nutrients !== null && nutrients.vitamins !== null && !nutrients.vitamins.vitamin.empty»
            val vitaminsNames = listOf(
	            «FOR vitamin : nutrients.vitamins.vitamin SEPARATOR ", "»
	            "«translateVitaminName(vitamin.toString())»"
	            «ENDFOR»
            )
            «ELSE»
            val vitaminsNames = emptyList<String>()
            «ENDIF»
    ...
    def String translateVitaminName(String enumValue) {
        switch enumValue {
            case "VITAMIN_A": "Vitamin A"
            case "VITAMIN_B1": "Vitamin B1"
            case "VITAMIN_B2": "Vitamin B2"
            case "VITAMIN_B3": "Vitamin B3"
            case "VITAMIN_B4": "Vitamin B4"
            case "VITAMIN_B5": "Vitamin B5"
