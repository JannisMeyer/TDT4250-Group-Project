 ...
 * </p>
 * <ul>
 *   <li>{@link no.ntnu.tdt4250.recipe.Section#getOrderNumber <em>Order Number</em>}</li>
 * </ul>
 *
 * @see no.ntnu.tdt4250.recipe.RecipePackage#getSection()
...
public interface Section extends EObject {
	 ...
	 * @see no.ntnu.tdt4250.recipe.RecipePackage#getSection_OrderNumber()
	 * @model required="true"
	 * @generated
	 */
	int getOrderNumber();
	...
	/**
	 * Sets the value of the '{@link no.ntnu.tdt4250.recipe.Section#getOrderNumber <em>Order Number</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
