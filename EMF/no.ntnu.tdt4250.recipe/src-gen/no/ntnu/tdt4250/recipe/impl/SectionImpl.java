 ...
 * </p>
 * <ul>
 *   <li>{@link no.ntnu.tdt4250.recipe.impl.SectionImpl#getOrderNumber <em>Order Number</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class SectionImpl extends MinimalEObjectImpl.Container implements Section {
	...
	protected EClass eStaticClass() {
		return RecipePackage.Literals.SECTION;
	}
	...
	public void setOrderNumber(int newOrderNumber) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RecipePackage.SECTION__ORDER_NUMBER, oldOrderNumber,
					orderNumber));
	}
